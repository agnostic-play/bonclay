...
// CollectionRoutes extends BaseCRUDRoutes with collection-specific endpoints
type CollectionRoutes interface {
	BaseCRUDRoutes[entities.CollectionEntity]
}

type collectionRoutes struct {
	baseCRUDRoutes   BaseCRUDRoutes[entities.CollectionEntity]
...
func NewCollectionRoutes(
	...
	return &collectionRoutes{
		baseCRUDRoutes:   NewBaseCRUDRoutes(collectionServices),
