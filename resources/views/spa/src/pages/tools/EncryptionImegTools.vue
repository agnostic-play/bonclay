<template>
  <div class="encryption-imeg-tools-page">
    <div class="tool-card">
      <div class="tool-form">
        <div class="tool-header">
          <h2>
            <i class="pi pi-shield"></i>
            Encryption Imeg Tools
          </h2>
...
const beautifyInputJson = () => {
  ...
  inputData.value = JSON.stringify(JSON.parse(inputData.value), null, 2)
}

const beautifyOutputJson = () => {
  if (!isValidJson(outputData.value)) return
  outputData.value = JSON.stringify(JSON.parse(outputData.value), null, 2)
}
